...
st.title('Here is our car price prediction app.')
st.text('We gathered 3000 Prius price from CarsGuru, and create a Machine Learning Model to predict the true value of your car.')
